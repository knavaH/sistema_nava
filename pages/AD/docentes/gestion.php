...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="form-group">
                ...
                <div class="col-lg-2">
                    <a href="http://localhost/sistema_nava/pages/AD/docentes/"><button type="button" class="btn btn-primary btn-lg btn-block">Regresar</button></a>
                </div>
            </div>
  </div>
</div>
