...
<div class="container-fluid text-center">    
  <div class="row content">
        ...
        <h2>Lista de administradores</h2>
            <p>
                ...
                <table style="width:100%" class="table">
                    ...
                    <tr>
                    <?php $llamado->ConsultarBiblioteca(); ?>
                    </tr> 
                </table>
            </p>
    </div>
    <div class="form-group">
                ...
                <div class="col-lg-2">
                    <a href="http://localhost/sistema_nava/pages/AD/biblioteca/"><button type="button" class="btn btn-primary btn-lg btn-block">Regresar</button></a>
                </div>
            </div>
  </div>
</div>
