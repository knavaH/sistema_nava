...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-12 text-left"> 
        <br>
            <h2>Exportar asignaturas</h2>
        <br>
        <div class="form-group">
            <div class="col-lg-2">
                <?php if(!isset($_GET['Clave']))
                {
                    echo '<a href="http://localhost/sistema_nava/pages/AD/asignaturas/"><button type="button" class="btn btn-primary btn-lg btn-block">Regresar</button></a>';
                }
                else
                { 
                    echo '<a href="http://localhost/sistema_nava/pages/AD/asignaturas/gestion.php"><button type="button" class="btn btn-primary btn-lg btn-block">Regresar</button></a>';
                }
                ?>  
            </div>
        </div>
